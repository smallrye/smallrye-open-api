...
----
Specify a strategy to be used globally for generating operation IDs when not specified via an annotation or static OpenAPI input. Set to one of the following:
** `METHOD`
** `CLASS_METHOD`
