...
mvn versions:update-property -Dproperty=version.eclipse.microprofile.config -DnewVersion=[3.0.1] -N
mvn versions:update-property -Dproperty=version.io.smallrye.smallrye-config -DnewVersion=[3.0.0-RC4] -N
...
mvn versions:update-property -Dproperty=version.jetty -DnewVersion=[11.0.11] -N
mvn versions:set-property -Dproperty=version.resteasy -DnewVersion=6.0.3.Final -N
