...
public class LinkReader {
    ...
    public static Map<String, Link> readLinks(final AnnotationValue annotationValue) {
        ...
        for (AnnotationInstance nested : nestedArray) {
            String name = JandexUtil.stringValue(nested, MPOpenApiConstants.LINK.PROP_NAME);
    ...
    private static Link readLink(final AnnotationInstance annotationInstance) {
        ...
        link.setOperationRef(JandexUtil.stringValue(annotationInstance, MPOpenApiConstants.LINK.PROP_OPERATION_REF));
        link.setOperationId(JandexUtil.stringValue(annotationInstance, MPOpenApiConstants.LINK.PROP_OPERATION_ID));
        link.setParameters(readLinkParameters(annotationInstance.value(MPOpenApiConstants.LINK.PROP_PARAMETERS)));
        link.setDescription(JandexUtil.stringValue(annotationInstance, MPOpenApiConstants.LINK.PROP_DESCRIPTION));
        link.setRequestBody(JandexUtil.stringValue(annotationInstance, MPOpenApiConstants.LINK.PROP_REQUEST_BODY));
        link.setServer(ServerReader.readServer(annotationInstance.value(MPOpenApiConstants.LINK.PROP_SERVER)));
    ...
    private static Link readLink(final JsonNode node) {
        ...
        Link link = new LinkImpl();
        link.setRef(JsonUtil.stringProperty(node, MPOpenApiConstants.LINK.PROP_REF_VAR));

        link.setOperationRef(JsonUtil.stringProperty(node, MPOpenApiConstants.LINK.PROP_OPERATION_REF));
        link.setOperationId(JsonUtil.stringProperty(node, MPOpenApiConstants.LINK.PROP_OPERATION_ID));
        link.setParameters(readLinkParameters(node.get(MPOpenApiConstants.LINK.PROP_PARAMETERS)));
        link.setRequestBody(readObject(node.get(MPOpenApiConstants.LINK.PROP_REQUEST_BODY)));
        link.setDescription(JsonUtil.stringProperty(node, MPOpenApiConstants.LINK.PROP_DESCRIPTION));
        link.setServer(ServerReader.readServer(node.get(MPOpenApiConstants.LINK.PROP_SERVER)));
    ...
    private static Map<String, Object> readLinkParameters(final AnnotationValue annotationValue) {
        ...
        for (AnnotationInstance annotation : nestedArray) {
            String name = JandexUtil.stringValue(annotation, MPOpenApiConstants.LINK.PROP_NAME);
            if (name != null) {
                String expression = JandexUtil.stringValue(annotation, MPOpenApiConstants.LINK.PROP_EXPRESSION);
