...
public class ExternalDocsReader {
    ...
    public static ExternalDocumentation readExternalDocs(AnnotationInstance annotationInstance) {
        ...
        externalDoc.setDescription(
                JandexUtil.stringValue(annotationInstance, MPOpenApiConstants.EXTERNAL_DOCUMENTATION.PROP_DESCRIPTION));
        externalDoc.setUrl(JandexUtil.stringValue(annotationInstance, MPOpenApiConstants.EXTERNAL_DOCUMENTATION.PROP_URL));
        return externalDoc;
    }
    ...
    public static ExternalDocumentation readExternalDocs(final JsonNode node) {
        ...
        ExternalDocumentation externalDoc = new ExternalDocumentationImpl();
        externalDoc.setDescription(JsonUtil.stringProperty(node, MPOpenApiConstants.EXTERNAL_DOCUMENTATION.PROP_DESCRIPTION));
        externalDoc.setUrl(JsonUtil.stringProperty(node, MPOpenApiConstants.EXTERNAL_DOCUMENTATION.PROP_URL));
