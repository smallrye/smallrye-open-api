...
public class ParameterReader {
    ...
    public static Map<String, Parameter> readParameters(final AnnotationScannerContext context,
        ...
        AnnotationInstance[] nestedArray = annotationValue.asNestedArray();
        for (AnnotationInstance nested : nestedArray) {
            String name = JandexUtil.stringValue(nested, MPOpenApiConstants.PARAMETER.PROP_NAME);
    ...
    public static Parameter readParameter(final AnnotationScannerContext context,
        ...
        parameter.setName(JandexUtil.stringValue(annotationInstance, MPOpenApiConstants.PARAMETER.PROP_NAME));
        parameter.setIn(JandexUtil.enumValue(annotationInstance, MPOpenApiConstants.PARAMETER.PROP_IN,
                org.eclipse.microprofile.openapi.models.parameters.Parameter.In.class));

        // Params can be hidden. Skip if that's the case.
        Boolean isHidden = JandexUtil.booleanValue(annotationInstance, MPOpenApiConstants.PARAMETER.PROP_HIDDEN);
        if (Boolean.TRUE.equals(isHidden)) {
            ParameterImpl.setHidden(parameter, true);
            return parameter;
        }

        parameter.setDescription(JandexUtil.stringValue(annotationInstance, MPOpenApiConstants.PARAMETER.PROP_DESCRIPTION));
        parameter.setRequired(JandexUtil.booleanValue(annotationInstance, MPOpenApiConstants.PARAMETER.PROP_REQUIRED));
        parameter.setDeprecated(JandexUtil.booleanValue(annotationInstance, MPOpenApiConstants.PARAMETER.PROP_DEPRECATED));
        parameter.setAllowEmptyValue(
                JandexUtil.booleanValue(annotationInstance, MPOpenApiConstants.PARAMETER.PROP_ALLOW_EMPTY_VALUE));
        parameter.setStyle(JandexUtil.enumValue(annotationInstance, MPOpenApiConstants.PARAMETER.PROP_STYLE,
                org.eclipse.microprofile.openapi.models.parameters.Parameter.Style.class));
        parameter.setExplode(readExplode(JandexUtil.enumValue(annotationInstance, MPOpenApiConstants.PARAMETER.PROP_EXPLODE,
                org.eclipse.microprofile.openapi.annotations.enums.Explode.class)));
        parameter.setAllowReserved(
                JandexUtil.booleanValue(annotationInstance, MPOpenApiConstants.PARAMETER.PROP_ALLOW_RESERVED));
        parameter.setSchema(
                SchemaFactory.readSchema(context.getIndex(),
                        annotationInstance.value(MPOpenApiConstants.PARAMETER.PROP_SCHEMA)));
        parameter.setContent(
                ContentReader.readContent(context, annotationInstance.value(MPOpenApiConstants.PARAMETER.PROP_CONTENT),
                        ContentDirection.Parameter));
        parameter.setExamples(ExampleReader.readExamples(annotationInstance.value(MPOpenApiConstants.PARAMETER.PROP_EXAMPLES)));
        parameter.setExample(JandexUtil.stringValue(annotationInstance, MPOpenApiConstants.PARAMETER.PROP_EXAMPLE));
    ...
    public static Parameter readParameter(final JsonNode node) {
        ...
        parameter.setName(JsonUtil.stringProperty(node, MPOpenApiConstants.PARAMETER.PROP_NAME));
        parameter.setIn(readParameterIn(node.get(MPOpenApiConstants.PARAMETER.PROP_IN)));
        parameter.setDescription(JsonUtil.stringProperty(node, MPOpenApiConstants.PARAMETER.PROP_DESCRIPTION));
        parameter.setRequired(JsonUtil.booleanProperty(node, MPOpenApiConstants.PARAMETER.PROP_REQUIRED));
        parameter.setDeprecated(JsonUtil.booleanProperty(node, MPOpenApiConstants.PARAMETER.PROP_DEPRECATED));
        parameter.setAllowEmptyValue(JsonUtil.booleanProperty(node, MPOpenApiConstants.PARAMETER.PROP_ALLOW_EMPTY_VALUE));
        parameter.setStyle(readParameterStyle(node.get(MPOpenApiConstants.PARAMETER.PROP_STYLE)));
        parameter.setExplode(JsonUtil.booleanProperty(node, MPOpenApiConstants.PARAMETER.PROP_EXPLODE));
        parameter.setAllowReserved(JsonUtil.booleanProperty(node, MPOpenApiConstants.PARAMETER.PROP_ALLOW_RESERVED));
        parameter.setSchema(SchemaReader.readSchema(node.get(MPOpenApiConstants.PARAMETER.PROP_SCHEMA)));
        parameter.setContent(ContentReader.readContent(node.get(MPOpenApiConstants.PARAMETER.PROP_CONTENT)));
        parameter.setExamples(ExampleReader.readExamples(node.get(MPOpenApiConstants.PARAMETER.PROP_EXAMPLES)));
        parameter.setExample(readObject(node.get(MPOpenApiConstants.PARAMETER.PROP_EXAMPLE)));
        parameter.setRef(JsonUtil.stringProperty(node, MPOpenApiConstants.PARAMETER.PROP_REF_VAR));
