 ...
 */
public class SmallRyeDisabledApplicationPathTest
        extends ExtraSuiteTestBase<SmallRyeDisabledApplicationPathTest.ApplicationPathTestArquillian> {
    ...
    public static class ApplicationPathTestArquillian extends AppTestBase {
        ...
        public static WebArchive createDeployment() {
            return ShrinkWrap.create(WebArchive.class, "ApplicationPathTest.war")
                    ...
                    .addAsManifestResource("smallrye-disable-app-path.properties", "microprofile-config.properties");
        }
