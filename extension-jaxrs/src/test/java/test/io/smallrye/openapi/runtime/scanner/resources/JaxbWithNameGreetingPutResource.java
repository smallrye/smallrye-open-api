...
public class JaxbWithNameGreetingPutResource {

    // 1) Basic path var test
    @PUT
    @Path("/greet/{id}")
    public JaxbWithNameGreeting greet(JaxbWithNameGreeting greeting, @PathParam("id") String id) {
        return greeting;
    }
    ...
    public Response greetWithResponse(JaxbWithNameGreeting greeting, @PathParam("id") String id) {
    ...
    @APIResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(ref = "#/components/schemas/JaxbWithNameGreeting")))
    public Response greetWithResponseTyped(JaxbWithNameGreeting greeting, @PathParam("id") String id) {
        return Response.ok(greeting).build();
    }
