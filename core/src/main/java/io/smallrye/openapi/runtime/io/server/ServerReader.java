...
public class ServerReader {
    ...
    public static Server readServer(final AnnotationScannerContext context, final AnnotationInstance annotationInstance) {
        if (annotationInstance != null) {
            ...
            server.setUrl(context.annotations().value(annotationInstance, ServerConstant.PROP_URL));
            server.setDescription(context.annotations().value(annotationInstance, ServerConstant.PROP_DESCRIPTION));
            server.setVariables(
    ...
    public static List<AnnotationInstance> getServerAnnotations(AnnotationScannerContext context, AnnotationTarget target) {
