...
/**
 * @deprecated use {@link org.eclipse.microprofile.openapi.OASFactory#createPaths()} instead.
 */
@Deprecated(since = "4.0", forRemoval = true)
public class PathsImpl extends Paths implements MapModel<PathItem> { // NOSONAR
